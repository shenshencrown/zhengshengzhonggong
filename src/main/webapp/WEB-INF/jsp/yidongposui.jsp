...
<div id="submain">
    ...
    <div class="clearfix w1160 bc mt20 proudcts">
        ...
        <div class="f12 technologyTxt_pro" style="display:block;">
            <h2 class="jianjie_tit ml345"><p class="tc f21 jjtit pr">移动破碎站</p><p class="f14 tc">专业研发生产大中型矿山破碎、筛分、制砂设备的重工企业</p></h2>
            <div class="productscon mt10">
                <ul class="clearfix">
                    <form action="/ProductBuy.asp" method="Post" name="Inquire28" target="_blank">
                        <input type="hidden" name="Item" value="94349-538"/>
                        <li class="fl"><a href="/product/munmoveposuizhan_11/28.html"><img src="/picture/2016.10.17_9.44.37_6018.jpg" /></a><p class="fl"><em class="fl f16 ml10">多功能移动破碎…</em><em class="fr f12 pro_icon"><a class="cs_icon" href="/product/munmoveposuizhan_11/28.html">参数</a><a class="bj_icon" href="javascript:;" onclick="document.Inquire28.submit()">报价</a></em></p></li>
                    </form>
